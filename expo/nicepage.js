  ...
  442: function (t, e, i) {
    ...
    (bootstrap.Util = (function (t) {
      ...
      (bootstrap.Carousel = (function (t, e) {
            ...
            return (
              ...
              (e.to = function t(index) {
                ...
                if (!(index > this._items.length - 1 || index < 0)) {
                  if (this._isSliding)
                    return (
                      s["default"](this._element).one(A, function () {
                        return e.to(index);
                      }),
                      void 0
                    );
              ...
              (e._addTouchEventListeners = function t() {
                ...
                if (this._touchSupported) {
                  var i = function t(i) {
                      if (
                        e._pointerEvent &&
                        at[i.originalEvent.pointerType.toUpperCase()]
                      )
                  ...
                  if (
                    (s["default"](this._element.querySelectorAll(J)).on(
                      P,
                      function (t) {
                ...
                if (!this._triggerSlideEvent(f, v).isDefaultPrevented())
                  if (a && f) {
                    ...
                    if (s["default"](this._element).hasClass($)) {
                      ...
                      s["default"](a).removeClass(B),
                        s["default"](f).addClass(B),
                        (this._isSliding = false),
        ...
        return (
          s["default"](document).on(H, ot, Carousel._dataApiClickHandler),
          ...
          menu.outerHeight(),
            menu.each(function () {
              ...
              menu.find(".u-mega-popup").each(function () {
                var t = n(this);
                t.css({ left: "", width: "" }), t.outerHeight();
                var a = t.offset(),
                  s = (i.left - a.left) / e;
                t.css({ left: Math.round(s) + "px", width: o + "px" });
              });
            });
      }),
     ...
     * Copyright (c) 2019 Dmitry Semenov; */ !(function (a, factory) {
      ...
      var t = function (template, t, items, e) {
        ...
        var l = function () {
          ...
          Ve = function (t, e) {
            return (
              (Be.prevent = !$e(t.target, s.isClickableElement)),
              ft("preventDragEvent", t, e, Be),
              Be.prevent
            );
          },
          Ue = function (t, e) {
            ...
            if (!V)
              if (t.type.indexOf("touch") > -1) {
                if (t.touches && t.touches.length > 0)
                  if (((Ge[0] = Ue(t.touches[0], Xe)), t.touches.length > 1))
                    Ge[1] = Ue(t.touches[1], Ke);
              } else
                (Xe.x = t.pageX), (Xe.y = t.pageY), (Xe.id = ""), (Ge[0] = Xe);
            else
              (Ye = 0),
            ...
            if (ge) {
              ...
              if (0 !== t)
                if (
                  ...
                  if (!ke) return;
                  if (Ie) {
                    if (((Ie = false), Math.abs(Xt.x) >= Vt))
                      Xt.x -= ge[0].x - Gt.x;
                    if (Math.abs(Xt.y) >= Vt) Xt.y -= ge[0].y - Gt.y;
                  }
                  if (((Kt.x = Zt.x), (Kt.y = Zt.y), 0 === Xt.x && 0 === Xt.y))
                    return;
            ...
            var t,
              ...
              n = {
                ...
                panAnimLoop: function () {
                  if (zt.zoomPan)
                    if (
                      ((zt.zoomPan.raf = j(n.panAnimLoop)),
                      (n.now = ct()),
          ...
          ai = function (t, e) {
            ...
            if (
              ...
              qt("mainScroll", _e.x, c, m, i.easing.cubic.out, gt, function () {
                if ((Ht(), (Te = false), (re = -1), o || re !== h))
                  n.updateCurrItem();
                ...
                ui = setTimeout(
                  function () {
                    if ((ft("initialZoom" + (o ? "Out" : "In")), !o)) {
                      ...
                      if (e)
                        qt("initialZoom", 0, 1, u, i.easing.cubic.out, p, f);
        ...
        var zi = { history: true, galleryUID: 1 },
          ...
          Qi = function () {
            ...
            if (!Ui) if (-1 === ji.hash.indexOf(i)) Zi = true;
      ...
      !(function (e, i, n) {
        ...
        function o(t) {
          ...
          if (
            ...
            Rt = t.scale || 1;
          if (
            ((Ht = t.mobileDeceleration || k),
            (jt = false !== t.smoothScrolling),
            (Xt = t.smoothScrollingDuration || E),
        ...
        (o.prototype.refresh = function (t) {
          var e,
            ...
            a = false;
          if (t === n)
            (a = true), (Dt = []), (Yt = 0), (t = i.getElementsByTagName("*"));
            ...
            for (h = 0, p = Dt.length; h < p; h++)
              for (
                ...
                if ("relative" === c.mode)
                  pt(n),
                    (c.frame =
                      Ot.relativeToAbsolute(o, c.anchors[0], c.anchors[1]) - m),
                    pt(n, true);
                if (((c.frame += v), zt))
          ...
          at = function (t, e) {
            for (var i = 0, n = Dt.length; i < n; i++) {
              ...
              if (m || v) {
                ...
                if (m) {
                  if ((Tt(l, [y], [b, w]), _ && C > -1))
                    wt(l, h.eventType, qt), (o.lastFrameIndex = -1);
                } else if ((Tt(l, [b], [y, w]), _ && C < c))
                  wt(l, p.eventType, qt), (o.lastFrameIndex = c);
              ...
              (n = {
                ...
                for (var l in this.waypoints[a]) {
                  ...
                  if (
                    ...
                    (u.triggerPoint = Math.floor(h + m - f)),
                    (v = c < s.oldScroll),
          ...
          (bt = N(function (t, e, i, n, o) {
            ...
            if (!(p = T(t, "lazybeforeunveil", e)).defaultPrevented) {
              ...
              if (((l = t[f](a.srcsetAttr)), (s = t[f](a.srcAttr)), o))
                c = (u = t.parentNode) && v.test(u.nodeName || "");
              if (
                ((m = e.firesLoad || ("src" in t && (l || s || c))),
                (p = { target: t }),
                x(t, a.loadingClass),
                m)
              )
                clearTimeout(U), (U = h(ft, 2500)), C(t, gt, true);
