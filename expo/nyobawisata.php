  ...
  <body data-home-page="Home.html" data-home-page-title="Home" class="u-body u-xl-mode">
    <header class="u-align-center u-border-3 u-border-black u-border-no-left u-border-no-right u-border-no-top u-clearfix u-custom-border u-header" id="sec-35cc">
      <div class="u-clearfix u-sheet u-valign-middle-lg u-valign-middle-xl u-sheet-1">
        <form action="#" method="get" class="u-border-1 u-border-grey-30 u-expanded-width-sm u-expanded-width-xs u-search u-search-left u-white u-search-1">
          <button class="u-search-button" type="submit">
            <span class="u-search-icon u-spacing-10">
              <svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 56.966 56.966"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-0053"></use></svg>
              <svg
          ...
          <input class="u-search-input" type="search" name="search" value="" placeholder="Cari bang aldo" />
        </form>
    ...
    <section class="u-clearfix u-section-1" id="sec-57bb">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <h2 class="u-align-center u-subtitle u-text u-text-default u-text-1">Gunung</h2>
      </div>
    </section>
    <section class="u-clearfix u-white u-section-2" id="sec-f972">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-expanded-width u-list u-list-1">
          <div class="u-repeater u-repeater-1">
            <?php 
                    $result = mysqli_query($conn, "SELECT w.*, k.nama FROM wisata w join kategori_wisata k on (w.id_kategori=k.id_kategori) ORDER BY w.id_wisata DESC");
            ...
            <div class="u-container-style u-list-item u-repeater-item u-list-item-1">
              <div class="u-container-layout u-similar-container u-container-layout-1">
                <img class="u-expanded-width u-image u-image-default u-image-1" src="images/image/<?php echo $row['foto_gambar'];?>" alt="ini gambar" data-image-width="400" data-image-height="265" />
                <h1 class="u-text u-title u-text-1"><?php echo $row['nama_lokasi'];?></h1>
                <p class="u-text u-text-2"><?php echo $row['deskripsi'];?></p>
                <a
                  href="<?php echo $row['lokasi'];?>"
                  ...
                  ><?php echo $row['nama_lokasi'];?></a
                >
                <h2 class="u-subtitle u-text u-text-3">Entry Fee: Rp. <?php echo $row['harga_tiket'];?></h2>
              </div>
            </div>
            <!-- Akhir -->
            <?php
    ...
    <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-33b8">
      <div class="u-clearfix u-sheet u-sheet-1">
        <p class="u-small-text u-text u-text-variant u-text-1">INI COBO COBO</p>
      </div>
    </footer>
